...
Opening a pull request will trigger a[workflow](../.github/workflows/mlops_dabs_demo-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-xxxx.xx.azuredatabricks.net/explore/data/models/staging/mlops_dabs_demo/mlops_dabs_demo-model)
* [Prod model in UC](https://adb-xxxx.xx.azuredatabricks.net/explore/data/models/prod/mlops_dabs_demo/mlops_dabs_demo-model)
. 
